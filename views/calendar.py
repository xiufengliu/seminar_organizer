...
def show():
    ...
    with tab1:
        ...
        if not seminars:
            ...
            gb.configure_column("date", width=30)         # Smaller width for 'date'
            gb.configure_column("start_time", width=30)    # Small width for 'start_time'
            gb.configure_column("end_time", width=30)      # Small width for 'end_time'
